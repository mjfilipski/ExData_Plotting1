...
# Making plot 3: 
#-------------------------------------------------------------------
#start with a blank plot then fill in using "points" function:
with(hhdata, plot(datetime, Sub_metering_1, ylab="Energy sub metering", xlab="", type ="n"))
with(hhdata, lines(datetime, Sub_metering_1))
